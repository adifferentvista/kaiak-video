...
const BEFORE_ITEMS: { icon: LucideIcon; text: string; delay: number }[] = [
  { icon: Mail, text: "127 unread emails", delay: 0 },
  { icon: FileWarning, text: "Board report overdue", delay: 8 },
  { icon: PhoneMissed, text: "5 missed parent calls", delay: 16 },
  { icon: FileText, text: "Policy review pending", delay: 24 },
  { icon: Clock, text: "60+ hour weeks", delay: 32 },
];

const AFTER_ITEMS: { icon: LucideIcon; text: string; delay: number }[] = [
  { icon: Inbox, text: "Inbox auto-triaged", delay: 0 },
  { icon: BarChart3, text: "Reports auto-generated", delay: 8 },
  { icon: MessageSquare, text: "Parent updates sent", delay: 16 },
  { icon: Search, text: "Policies instantly searchable", delay: 24 },
  { icon: Target, text: "Focus on what matters", delay: 32 },
];
        ...
        >
          ...
          <div
            style={{
              ...
              background:
                "linear-gradient(180deg, transparent, #e2711d, transparent)",
              borderRadius: 2,
              position: "relative",
              display: "flex",
              alignItems: "center",
