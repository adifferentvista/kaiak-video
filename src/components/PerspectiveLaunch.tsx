...
export const PerspectiveLaunch = () => {
  const frame = useCurrentFrame();

  // 3D rotation that slowly shifts over time
    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: 16,
          overflow: "hidden",
          boxShadow: `${shadowX}px ${shadowY}px 80px rgba(0,0,0,0.5), 0 0 40px rgba(251,191,36,0.05)`,
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    backgroundColor: i === 0 ? "rgba(251,191,36,0.08)" : "transparent",
                    borderLeft: i === 0 ? "3px solid #fbbf24" : "3px solid transparent",
                    opacity: navOpacity,
                  }}
                >
                  {item}
