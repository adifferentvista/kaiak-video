...
type ItemType = { icon: PhosphorIcon; text: string; delay: number };

const BEFORE_ITEMS: ItemType[] = [
  { icon: EnvelopeSimple, text: "127 unread emails", delay: 0 },
  { icon: FileX, text: "Board report overdue", delay: 8 },
  { icon: PhoneSlash, text: "5 missed parent calls", delay: 16 },
  { icon: FileText, text: "Policy review pending", delay: 24 },
  { icon: Clock, text: "60+ hour weeks", delay: 32 },
];

const AFTER_ITEMS: ItemType[] = [
  { icon: Tray, text: "Inbox auto-triaged", delay: 0 },
  { icon: ChartBar, text: "Reports auto-generated", delay: 8 },
  { icon: ChatCircleText, text: "Parent updates sent", delay: 16 },
  { icon: MagnifyingGlass, text: "Policies instantly searchable", delay: 24 },
  { icon: Crosshair, text: "Focus on what matters", delay: 32 },
];
...
export const BeforeAfterPhosphor = () => {
  const frame = useCurrentFrame();
