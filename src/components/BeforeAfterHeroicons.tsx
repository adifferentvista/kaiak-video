...
type ItemType = { icon: IconType; text: string; delay: number };

const BEFORE_ITEMS: ItemType[] = [
  { icon: HiOutlineEnvelope, text: "127 unread emails", delay: 0 },
  { icon: HiOutlineDocumentMinus, text: "Board report overdue", delay: 8 },
  { icon: HiOutlinePhoneXMark, text: "5 missed parent calls", delay: 16 },
  { icon: HiOutlineDocumentText, text: "Policy review pending", delay: 24 },
  { icon: HiOutlineClock, text: "60+ hour weeks", delay: 32 },
];

const AFTER_ITEMS: ItemType[] = [
  { icon: HiOutlineInboxArrowDown, text: "Inbox auto-triaged", delay: 0 },
  { icon: HiOutlineChartBar, text: "Reports auto-generated", delay: 8 },
  { icon: HiOutlineChatBubbleLeftRight, text: "Parent updates sent", delay: 16 },
  { icon: HiOutlineMagnifyingGlass, text: "Policies instantly searchable", delay: 24 },
  { icon: HiOutlineRocketLaunch, text: "Focus on what matters", delay: 32 },
];
...
export const BeforeAfterHeroicons = () => {
  const frame = useCurrentFrame();
