...
const WEEKS = [
  {
    ...
    icon: "fluent-emoji/magnifying-glass-tilted-right.svg",
    color: "#8b5cf6",
  },
  {
    week: "Week 3-4",
...
export const CourseOverviewFluent = () => {
  const frame = useCurrentFrame();
